...
<head>
 ...
 <body class="inside">
      ...
      <!-- END MUST DECLARE HERE THE FF -->
        ...
        <section>
            <div class="container">
              <div class="row">
                  ...
                  <div class="col-md-3">
                      <h5>All Openday Promotion with total consumed amount</h5>
                  ...
                  <div class="col-md-3">
                      <h5>All Job List Promotion with total consumed amount</h5>
                      <table class="table tabl-bordered">
                        <thead>
                          <tr>
                            <th>Job Post Name</th>
                   ...
                   <div class="col-md-3">
                      <h5>All Candidate Promotion with total consumed amount</h5>
                      <table class="table tabl-bordered">
                        <thead>
                          <tr>
                  ...
                  <div class="col-md-3">
                      <h5>All Page Promotion with total consumed amount</h5>
                      <table class="table tabl-bordered">
                        <thead>
                          <tr>
                            <th>Company Name</th>
        ...
        ?>
            <script type="text/javascript" src="js/app/list-all-promotion.js"></script>
    </body>
</html>